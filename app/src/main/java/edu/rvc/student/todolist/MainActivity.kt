package edu.rvc.student.todolist
     ...
     //   val database = FirebaseDatabase.getInstance()
      ...
      //  myRef.setValue("Hello, World")
        ...
        btnMessage.setOnClickListener{
            ...
            var message = Message(messageid.toString(), task.text.toString(), names.text.toString())
            hideKeyboard()
            task.setText("")
            names.setText("")
            txtTask.requestFocus()
            ref.child(messageid.toString()).setValue(message).addOnCompleteListener {
